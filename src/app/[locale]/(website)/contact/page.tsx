  ...
  return (
    <>
      <Background
        ...
        className="flex md:h-full h-screen text-center items-center justify-center md:text-7xl text-5xl  italic font-bold max-w-lg mx-auto"
        title={"Contact Us"}
        showButton={false}
      />
      <div className="p-4 text-xl text-center"><ContactForm /></div>
    </>
  );
}
