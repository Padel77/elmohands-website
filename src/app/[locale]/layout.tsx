...
export const metadata: Metadata & {
  ...
  title: {
    template:
      "%s |  المهندس لشراء الاثاث المستعمل | شراء اثاث مستعمل بالرياض ",
    default:
      " شراء الاثاث المستعمل بالرياض | المهندس لشراء الأثاث المستعمل |  أفضل الأسعار والخدمات في  شراء الاثاث فى الرياض",
  },
  description:
